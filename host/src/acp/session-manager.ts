...
import type { AnswerQuestionsRequest, AttachAgyRequest, AttachClaudeRequest, AttachRequest, Bot, DispatchRequest, DispatchSession, PendingApproval, PendingQuestion, PromptImage, PublicToolCallDetail, SessionEvent, SessionNote, SessionTask, ToolCallRecord, TranscriptEntry, ReviewWorkRequest, TransferProfileRequest } from "../types.js";
...
import { APPROVAL_SWEEP_INTERVAL_MS, DEFAULT_APPROVAL_TTL_MS, botTaggedTitle, buildOrphanedApprovalResumePrompt, claudeApprovalSignature, composeGrokOpeningPrompt, expiresInIso, grokApprovalSignature, isSafeBashCommand, lastUserTextIs, matchesProfileAllowlist, now, shortTitle, shouldFlipToIdleAfterTurn, toolNameFromParkedApproval } from "./session-helpers.js";
import { findClaudeTranscriptPath, findPendingAskUserTool, isGrokExitPlanApproval, mapAgentExitError, materializeImagesInCwd, normalizeImages, rawIsExitPlan, savePromptImagesForSession } from "./session-support.js";
...
import { flushAssistant as flushAssistantImpl, handleGrokAgentMessage } from "./runners/grok-events.js";
...
export class SessionManager extends EventEmitter {
  ...
  private handleAgentMessage(live: LiveSession, msg: { id?: number | string; method: string; params?: unknown }): Promise<void> {
    return handleGrokAgentMessage(this.turnCtx, live, msg);
  }

  private flushAssistant(live: LiveSession): void {
    flushAssistantImpl(this.turnCtx, live);
  }
